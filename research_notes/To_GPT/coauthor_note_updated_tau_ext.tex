...
\begin{enumerate}[leftmargin=2em]
    \item 把论文对象从 \texttt{firm-state transition-centered} 改成
    \texttt{product-level commercialization assignment-centered}；
...
通过降低 route-specific governance/compliance friction：
\[
\tau_{ext}^{post}<\tau_{ext}^{pre}.
\]
\end{quote}
