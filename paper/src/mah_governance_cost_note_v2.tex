...
\section{What \texorpdfstring{$\tau_{ext}$}{tau_ext} is and what it is not}
...
\section{Where \texorpdfstring{$\tau_{ext}$}{tau_ext} enters the model}
...
\begin{enumerate}[leftmargin=2em]
    ...
    \]
    This captures whether the product is commercialized through separated holder--manufacturer roles.
...
\section{How \texorpdfstring{$\tau_{ext}$}{tau_ext} is calibrated}
