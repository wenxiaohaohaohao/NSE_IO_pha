...
\paragraph{Weak internal capability.}
For every \(k_i>0\), internalization is feasible in principle. At low
capability, high \(c_I(m,k_i)\) and \(F_I(m,k_i)\) can make \(W_i^I\) very
low. The optional limit \(F_I(m,k)\to+\infty\) as \(k\downarrow0\) is a
continuous boundary, not a hard cutoff.
