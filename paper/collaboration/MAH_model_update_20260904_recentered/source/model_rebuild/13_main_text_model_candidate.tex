...
project-advancement capability \(a_i>0\) and internal manufacturing capability
...
\(F_{I,m}>0\) and \(F_{I,k}<0\). Both are finite for every \(k_i>0\).
Weak existing capability therefore makes building, acquiring, validating, or
adapting internal capacity expensive without making internalization
permanently impossible. Its route value is
\begin{equation}
  W_i^I(q,m)
  =
