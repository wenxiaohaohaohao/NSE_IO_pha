% Phase 5 only: common project-advancement problem and value-gap foundation.
...
optimized route value from Phase~4. CMO market consistency and the feedback
that selects \(p_m^*\) remain deferred to Phase~6.
...
Phase~4 maximum contains abandonment with value zero,
...
At a fixed \(p_m\), Phase~4 implies the pointwise weak ordering
\[
...
\subsection{Appendix-oriented downstream value gap}
\label{subsec:p05-value-gap}

For the later appendix split, let \(B_i\) denote the continuation-value
