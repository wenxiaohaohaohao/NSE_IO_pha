...
\begin{equation}
  ...
  \qquad
  c_{I,k}(m,k_i)<0
  \quad\text{on the interior of the feasible domain}.
...
\end{equation}
On the interior of the feasible domain, assume smoothness and
\(F_{I,m}>0\) and \(F_{I,k}<0\). Derivatives are not taken across the
feasibility boundary. Thus low internal capability makes route \(I\) unavailable through an
