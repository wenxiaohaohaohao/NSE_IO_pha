...
- The financing note is a user-authorized post-Phase-18 supplemental
  specification. It does not rewrite the approved v1.2 source or historical
  Phase 1--18 gate records.
