...
convergence. Thus aggregate regularity comes from continuous project and
developer heterogeneity, not smooth random utility.
...
\begin{enumerate}
  \item conjecture \(p_m\);
  \item evaluate route values and deterministic
  \(r_i^*(q,m;M,p_m)\);
