% Phase 4 only: route values, deterministic choice, and conditional sorting.
\section{Route Values and Organizational Sorting}
\label{sec:p04-route-sorting}

This section composes the Phase~2 commercial-value kernel with the Phase~3
manufacturing technologies. It treats the qualified manufacturing-service
price \(p_m\) as fixed and conjectured. Market consistency for \(p_m^*\) is
deferred to Phase~6.
...
\subsection{Organizational sorting proposition draft}
\label{subsec:p04-sorting-proposition}

Suppose the approved Phase~2--3 technology and derivative restrictions hold,
...
\subsection{Zero-effect and non-tautology audit}
