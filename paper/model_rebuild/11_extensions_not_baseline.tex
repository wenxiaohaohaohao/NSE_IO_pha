...
propositions. Five blocks remain only documented possibilities. Following
explicit approval on 2026-09-03, Extension 6 is formalized in the separate
module \texttt{15\_research\_development\_patent\_extension.tex}, with its
own assumptions, proofs, CMO-price feedback, and empirical boundaries.
...
This block is now activated only as a separately tagged extension. It uses
upstream research \(x_i^R\), project development \(x_i^D\), a common resource
ceiling, and an explicit patent-production equation. The complete objective,
KKT system, slack/binding comparative statics, binary-policy mapping, and
boundary cases appear in Section~\ref{sec:erd-extension}.
...
The first five optional blocks remain inactive. The sixth is active only in
its standalone extension and cannot be cited as a baseline mechanism or
assumption. Conversely, the baseline does not depend on any extension-only
symbol or equation.
