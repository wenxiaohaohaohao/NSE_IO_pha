% Phase 11 only: quarantined, inactive extensions.
\section{Explicit Extensions: Not the Baseline}
\label{sec:p11-extensions}

\textbf{Quarantine rule.} Every object in this section is inactive in the
baseline. None enters the Phase~1--10 symbols, assumptions, equilibrium,
propositions, empirical mapping, or manuscript candidate. Activating any block
requires a separate user-approved architecture change, its own assumptions,
proofs, data justification, and audit.
...
need, shock-scale identification, and separate approval. Deterministic
...
data, a causal justification for any policy dependence, and separate approval.
...
counterparty choice is selected here. Until a separately approved design
...
written here because no state vector or transition law has been approved. This
...
An optional, separately approved block may use two controls: upstream research
...
mechanisms or assumptions. Conversely, the baseline modules do not import this
