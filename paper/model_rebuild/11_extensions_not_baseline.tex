...
on any extension-only symbol or equation. Commercialization financing
capacity, route-level liquidity thresholds, borrowing, debt contracts, VC
bargaining, bank screening, endogenous interest rates, and finance-market
clearing remain outside the baseline. The separately labeled financing
extension formalizes only the first two objects and remains inactive.
